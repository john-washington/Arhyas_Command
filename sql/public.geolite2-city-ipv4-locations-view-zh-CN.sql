-- View: public.geolite2-city-ipv4-locations-view-zh-CN

-- DROP VIEW public."geolite2-city-ipv4-locations-view-zh-CN";

CREATE OR REPLACE VIEW public."geolite2-city-ipv4-locations-view-zh-CN"
 AS
 SELECT a.network,
    a.geoname_id,
  ...
  WHERE b.locale_code::text = 'zh-CN'::text
  ORDER BY a.geoname_id, b.locale_code;

ALTER TABLE public."geolite2-city-ipv4-locations-view-zh-CN"
