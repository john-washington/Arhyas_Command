-- View: public.geolite2-city-ipv4-locations-view-pt-BR

-- DROP VIEW public."geolite2-city-ipv4-locations-view-pt-BR";

CREATE OR REPLACE VIEW public."geolite2-city-ipv4-locations-view-pt-BR"
 AS
 SELECT a.network,
    a.geoname_id,
  ...
  WHERE b.locale_code::text = 'pt-BR'::text
  ORDER BY a.geoname_id, b.locale_code;

ALTER TABLE public."geolite2-city-ipv4-locations-view-pt-BR"
