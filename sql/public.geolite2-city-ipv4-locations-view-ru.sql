-- View: public.geolite2-city-ipv4-locations-view-ru

-- DROP VIEW public."geolite2-city-ipv4-locations-view-ru";

CREATE OR REPLACE VIEW public."geolite2-city-ipv4-locations-view-ru"
 AS
 SELECT a.network,
    a.geoname_id,
  ...
  WHERE b.locale_code::text = 'ru'::text
  ORDER BY a.geoname_id, b.locale_code;

ALTER TABLE public."geolite2-city-ipv4-locations-view-ru"
