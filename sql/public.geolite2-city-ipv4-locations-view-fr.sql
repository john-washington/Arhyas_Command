-- View: public.geolite2-city-ipv4-locations-view-fr

-- DROP VIEW public."geolite2-city-ipv4-locations-view-fr";

CREATE OR REPLACE VIEW public."geolite2-city-ipv4-locations-view-fr"
 AS
 SELECT a.network,
    a.geoname_id,
  ...
  WHERE b.locale_code::text = 'fr'::text
  ORDER BY a.geoname_id, b.locale_code;

ALTER TABLE public."geolite2-city-ipv4-locations-view-fr"
