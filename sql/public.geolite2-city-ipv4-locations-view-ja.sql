-- View: public.geolite2-city-ipv4-locations-view-ja

-- DROP VIEW public."geolite2-city-ipv4-locations-view-ja";

CREATE OR REPLACE VIEW public."geolite2-city-ipv4-locations-view-ja"
 AS
 SELECT a.network,
    a.geoname_id,
  ...
  WHERE b.locale_code::text = 'ja'::text
  ORDER BY a.geoname_id, b.locale_code;

ALTER TABLE public."geolite2-city-ipv4-locations-view-ja"
