-- FUNCTION: public.circle_search_on_centerpoint_ja(numeric, numeric, integer)

-- DROP FUNCTION IF EXISTS public.circle_search_on_centerpoint_ja(numeric, numeric, integer);

CREATE OR REPLACE FUNCTION public.circle_search_on_centerpoint_ja(
...
h.is_in_european_union
	FROM public."geolite2-city-ipv4-locations-view-ja" h 
...
ALTER FUNCTION public.circle_search_on_centerpoint_ja(numeric, numeric, integer)
    OWNER TO postgresql_master;

GRANT EXECUTE ON FUNCTION public.circle_search_on_centerpoint_ja(numeric, numeric, integer) TO PUBLIC;

GRANT EXECUTE ON FUNCTION public.circle_search_on_centerpoint_ja(numeric, numeric, integer) TO featureserver;

GRANT EXECUTE ON FUNCTION public.circle_search_on_centerpoint_ja(numeric, numeric, integer) TO postgresql_master;
