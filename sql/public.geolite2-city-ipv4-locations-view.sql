-- View: public.geolite2-city-ipv4-locations-view

-- DROP VIEW public."geolite2-city-ipv4-locations-view";

CREATE OR REPLACE VIEW public."geolite2-city-ipv4-locations-view"
 AS
 SELECT a.network,
    a.geoname_id,
...
ALTER TABLE public."geolite2-city-ipv4-locations-view"
