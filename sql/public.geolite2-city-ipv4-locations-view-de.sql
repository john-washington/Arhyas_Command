-- View: public.geolite2-city-ipv4-locations-view-de

-- DROP VIEW public."geolite2-city-ipv4-locations-view-de";

CREATE OR REPLACE VIEW public."geolite2-city-ipv4-locations-view-de"
 AS
 SELECT a.network,
    a.geoname_id,
  ...
  WHERE b.locale_code::text = 'de'::text
  ORDER BY a.geoname_id, b.locale_code;

ALTER TABLE public."geolite2-city-ipv4-locations-view-de"
