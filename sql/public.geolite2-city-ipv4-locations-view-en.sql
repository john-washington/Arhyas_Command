-- View: public.geolite2-city-ipv4-locations-view-en

-- DROP VIEW public."geolite2-city-ipv4-locations-view-en";

CREATE OR REPLACE VIEW public."geolite2-city-ipv4-locations-view-en"
 AS
 SELECT a.network,
    a.geoname_id,
  ...
  WHERE b.locale_code::text = 'en'::text
  ORDER BY a.geoname_id, b.locale_code;

ALTER TABLE public."geolite2-city-ipv4-locations-view-en"
